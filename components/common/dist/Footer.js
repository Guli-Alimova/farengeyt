        ...
        react_1["default"].createElement("div", { className: "container" },
            react_1["default"].createElement("div", { className: "max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10" },
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("div", { className: "w-[86px] max-w-full" },
                        react_1["default"].createElement(link_1["default"], { href: "/" },
                            react_1["default"].createElement(image_1["default"], { src: "/images/Farengeyt_Press_LOGO_small.png", alt: "farengeyt", className: "h-auto w-full", height: 300, width: 300 }))),
                ...
                react_1["default"].createElement("div", { className: 'relative text-white' },
                    ...
                    react_1["default"].createElement(image_1["default"], { src: "/images/frame-shape.png", alt: "", className: 'absolute  bottom-9 left-14 animate-float-x', width: 300, height: 300 }))))));
}
