...
var Intro = function () {
    return (react_1["default"].createElement("div", { className: " relative bg-blue-100 overflow-hidden    pb-20" },
        ...
        react_1["default"].createElement(image_1["default"], { src: "/images/frame-shape.png", alt: "shape", className: "hidden lg:inline absolute bottom-[28%] right-[24%] w-[185px] animate-float-x", width: 185, height: 185 }),
        react_1["default"].createElement(image_1["default"], { src: "/images/xstar.png", alt: "star", className: "absolute top-[31%] right-[38%] w-[55px] animate-rotate-half ", width: 55, height: 55 }),
        react_1["default"].createElement(image_1["default"], { src: "/images/book.png", alt: "", className: "absolute bottom-[1%] left-[-1%] w-[216px] rotate-[-10deg]", width: 216, height: 216 }),
        react_1["default"].createElement(image_1["default"], { src: "/images/frame-2.png", alt: "", className: "hidden lg:inline absolute bottom-[0%] right-[42%] w-[254px] opacity-70 animate-float-y", width: 254, height: 254 })));
};
